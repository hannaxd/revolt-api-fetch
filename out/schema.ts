...
export interface components {
  schemas: {
    ...
    BulkMessageResponse: OneOf<[components["schemas"]["Message"][], {
    ...
    DataDefaultChannelPermissions: OneOf<[{
      /**
       * Format: uint64
    ...
    FetchServerResponse: OneOf<[components["schemas"]["Server"], {
      /** @description Channels within this server */
      channels: string[];
      /** @description Unique Id */
      _id: string;
    ...
    MemberResponse: OneOf<[components["schemas"]["Member"], {
